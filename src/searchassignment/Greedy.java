...
public class Greedy { 
    ...
    void GreedyBestFirst ( int grid[][], boolean visited[][], int n, int m, int i, int j, int end_i, int end_j ) {
        // Initializing static goal index variables
        goal_i = end_i;
        goal_j = end_j; 
        
        // Creating a Priority Queue Data Structure
        Comparator<State> comparator = new GreedyPairComparator();
...
class GreedyPairComparator implements Comparator<State> {
    @Override
